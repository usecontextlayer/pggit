 ...
 *
 *   NODE_OPTIONS=--expose-gc npx tsx perf/probes/perf/incremental-fetch.ts [--sizes=250,500,1000,2000]
 */
...
import { cleanupTmp, mb, mkTmp, secs, seedRepo } from "@perf/probes/perf/_util"
import { z } from "zod"
